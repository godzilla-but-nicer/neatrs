use crate::neural_network::edge::{EdgeGene, Edge};
...
struct Alignment {
    ...
    p1_edgeome: Vec<EdgeLocus>,
    p1_nodeome: Vec<Node>,

    p2_edgeome: Vec<EdgeLocus>,
    p2_nodeome: Vec<Node>,
...
impl Alignment {
    ...
    mod tests {
        ...
        fn test_from_parents() {
            ...
            let known_1_node_idx = vec![0, 1, 2, 3, 4, 5, 6];
            let known_2_node_idx = vec![0, 1, 2, 3, 4, 5, 6, 8];
